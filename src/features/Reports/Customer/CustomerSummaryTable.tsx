...
import { SummarySortField, SortOrder, PartySummary } from '@/utils/types';
...
const CustomerSummaryTable = (props: InventoryTableProps) => {
                            ...
                            <Box sx={{
                                ...
                                <Box sx={{ textAlign: 'center', maxWidth: 400 }}>
                                    ...
                                    <Typography variant="body1" color="text.secondary" sx={{ mb: 3, lineHeight: 1.6 }}>
                                        Your inventory appears to be empty or no customer match your current search criteria.
                                    </Typography>
                                    <Typography variant="body2" color="text.secondary">
                                        Try adjusting your filters or add new customers to get started.
                                    </Typography>
                                </Box>
                        ...
                        <Table sx={{ width: '100%' }} stickyHeader>
                            ...
                            <TableBody>
                                {summaryData?.map((item, index) => {
                                    ...
                                    return (
                                        <CustomerSummaryRow
                                            key={`${item.party_name}-${item.party_tin}-${index}`}
                                            row={item}
                                            serial={serial}
                                        />
                                    );
