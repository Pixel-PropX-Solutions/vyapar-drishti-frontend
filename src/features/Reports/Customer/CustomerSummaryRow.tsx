...
import { PartySummary } from '@/utils/types';
...
export const CustomerSummaryRow = (props: InventoryRowRowProps) => {
                                        ...
                                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                                            ...
                                            <Box>
                                                ...
                                                <Typography variant="body2" color="text.secondary">
                                                    Complete transaction history for {row.party_name}
                                                </Typography>
                                            </Box>
                                        </Box>
                                    </Box>
                                                ...
                                                <TableBody>
                                                    {row.invoices && row.invoices.length > 0 ? (
                                                        row.invoices.map((invoice, index) => (
                                                            <Zoom
                                                                key={`${invoice.voucher_id}-${index}-${invoice.voucher_number}`}
                                                                in={open}
