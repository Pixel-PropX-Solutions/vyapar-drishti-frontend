...
import { SummarySortField, SortOrder, BillSummary } from '@/utils/types';
...
const BillSummaryTable = (props: InventoryTableProps) => {
                            ...
                            <Box sx={{
                                ...
                                <Box sx={{ textAlign: 'center', maxWidth: 400 }}>
                                    ...
                                    <Typography variant="body1" color="text.secondary" sx={{ mb: 3, lineHeight: 1.6 }}>
                                        Your inventory appears to be empty or no invoices match your current search criteria.
                                    </Typography>
                                    <Typography variant="body2" color="text.secondary">
                                        Try adjusting your filters or add new invoices to get started.
                                    </Typography>
                                </Box>
                        ...
                        <Table sx={{ width: '100%' }} stickyHeader>
                            ...
                            <TableBody>
                                {summaryData?.map((item, index) => {
                                    ...
                                    return (
                                        <BillSummaryRow
                                            key={`${item.voucher_number}-${item._id}-${index}`}
                                            row={item}
                                            serial={serial}
                                        />
                                    );
