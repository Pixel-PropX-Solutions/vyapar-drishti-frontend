...
export const ExpenseRow: React.FC<ExpenseRowProps> = ({ inv, onDelete, onEdit, onView, onPrint, index, selected, onSelect }) => {
            ...
            <Fade in timeout={300 + index * 100}>
                ...
                >
                    ...
                    <TableCell align="left">
                        ...
                        >
                            {inv.paid_amount === 0 ? 'Pending' : inv.paid_amount < inv.grand_total ? 'Partially Paid' : "Paid"}
                        </Typography>
                    </TableCell>
                    ...
                    <TableCell align="left" sx={{ px: 1 }}>
                        ...
                        >
                            {inv.voucher_number ? `${inv.voucher_number}` : ''}
                        </Typography>
                    </TableCell>
