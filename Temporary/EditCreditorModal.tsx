...
>>>>>>> 5c5a27c4386cee0a00ece93aada65cbc238ee637
        switch (field) {
            ...
            case 'mailing_country':
                if (!value.trim()) return 'Mailing country is required';
                if (value.trim().length < 2) return 'Mailing country must be at least 2 characters';
                return '';
            case 'mailing_state':
            ...
            case 'mailing_pincode':
                if (!value.trim()) return 'Mailing pincode is required';
...
>>>>>>> 5c5a27c4386cee0a00ece93aada65cbc238ee637
    ...
    const handleSubmit = async () => {
        ...
        if (data.mailing_address && data.mailing_address !== '') sanitizedData.mailing_address = data.mailing_address.trim();
        if (data.mailing_country && data.mailing_country !== '') sanitizedData.mailing_country = data.mailing_country.trim();
        if (data.mailing_pincode && data.mailing_pincode !== '') sanitizedData.mailing_pincode = data.mailing_pincode.trim();
...
>>>>>>> 5c5a27c4386cee0a00ece93aada65cbc238ee637
                    ...
                    >
                        Customer details updated successfully! Redirecting...
                    </Alert>
                </Collapse>
            </Box>
                        ...
                        <CardContent sx={{ p: 3 }}>
                            ...
                            <FormControl fullWidth sx={{ mb: 2 }}>
                                ...
                                <TextField
                                    ...
                                    helperText={validationErrors.mailing_name}
                                    InputProps={{
                                        startAdornment: (<InputAdornment position="start">
                                            <Business fontSize="small" />
                                        </InputAdornment>),
                                        endAdornment: !validationErrors.mailing_name && (
                                            <InputAdornment position="end">
                                                <CheckCircle color="success" fontSize="small" />
                                            </InputAdornment>
                                        )
                                ...
                                <Box sx={{ width: '50%' }}>
                                    <FormControl fullWidth sx={{ mb: 2 }}>
                                        ...
                                        <TextField
                                            ...
                                            helperText={validationErrors.mailing_address}
                                            InputProps={{
                                                startAdornment: (<InputAdornment position="start">
                                                    <CreditCard fontSize="small" />
                                                </InputAdornment>),
...
>>>>>>> 5c5a27c4386cee0a00ece93aada65cbc238ee637
                            ...
                            <FormControl fullWidth sx={{ mb: 2 }}>
                                ...
                                <TextField
                                    ...
                                    helperText={validationErrors.mailing_pincode}
                                    InputProps={{
                                        startAdornment: (<InputAdornment position="start">
                                            <Label fontSize="small" />
                                        </InputAdornment>),
                                        endAdornment: !validationErrors.mailing_pincode && (
                                            <InputAdornment position="end">
                                                <CheckCircle color="success" fontSize="small" />
                                            </InputAdornment>
                                        )
